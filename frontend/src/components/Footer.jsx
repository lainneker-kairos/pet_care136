                ...
                <div>
                    ...
                    <div className="flex gap-3 mt-3">
                        ...
                        <a
                            href="#"
                            aria-label="Facebook"
                            className="flex h-10 w-10 items-center justify-center rounded-full bg-white text-purple-600 hover:bg-purple-600 hover:text-white transition-colors shadow-sm"
                        >
